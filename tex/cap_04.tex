...
Para armazenar os dados de ambos os módulos, estamos usando os serviços de Storage e de Realtime Database providos pelo Firebase, este que além de ser provedor de serviços na nuvem também oferece \textit{backend} como sendo um serviço.
