\chapter{Back-end como serviço}

	explicar o que seriam softwares como servico (SaaS)

\section{Definição}
	(Copia)
	Back-end as a service (Back-end como serviço) é um tipo de SaaS que prevê o
suporte para que uma ou mais aplicações funcionem sem a necessidade do
desenvolvimento back-end. 

\section{Funcionalidades / Oportunidades}
	
	As funcionalidades dos Back-ends como serviços varia de acordo com a empresa que está provendo o serviço e com qual finalidade o serviço foi contratado, dentre os serviços mais comuns estão armazenamento de dados, gerenciamento de usuários, notificações assincronas e integração com redes sociais (ref 11 e 12 texto franciely)
	...
	% contexto
	Todo sistema possui usuarios cadastrados e as devidas permissões que cada um deles tem ao sistema. BaaS oferecem serviços diferentes de acordo com as necessidades do cliente. Firebase por exemplo, permite login anonimo ou usando redes sociais ou e-mail, tambem permite gerir quais as permissões que cada usuario tem.

	\subsection{Gerenciamento de Dados}
	% definição
	o que é: disponibiliza ao desenvolvedor meios para armazenar e acessar os dados gerados por sua aplicação. No geral, a gerencia de dados é feita através de interfaces simples e intuitivas (ref 11);
...
\section{Desafios}
	...
	% definição
	é uma acção que é muito importe entre o sistema que trata de diferentes versoes da informaçao em diferentes clientes. esse tipo de atividade geralmente gera um problema arquitetural que envolve tanto o momento que vai ser sincronizado e o que vai ser sincronizado e como vai ser sincronizado.
	...
	% contexto
	assim como explicado na seção {/precificação}
