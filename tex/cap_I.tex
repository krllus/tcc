...
\section{Definição}
	(Copia)
	Back-end as a service (Back-end como serviço) é um tipo de SaaS que prevê o suporte para que uma ou mais aplicações funcionem sem a necessidade do desenvolvimento back-end. 
